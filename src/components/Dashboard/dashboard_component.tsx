...
import { TrendingUp, BookOpen, DollarSign, Users, Eye, ThumbsUp, MessageCircle } from "lucide-react"
...
export const dummyCards: CardType[] = [
  {
    ...
    likes: 1240,
    views: 5430,
    content: <p>Discover the hidden beaches and breathtaking cliffs along the Pacific Coast Highway.</p>,
  },
  {
    ...
    content: (
      <div className="flex flex-col gap-2">
        <p>AI-driven code generation and edge computing are changing the landscape fast.</p>
  ...
  },
  {
    ...
    likes: 954,
    views: 2110,
    content: <p>A quick guide to grounding yourself before starting a busy, fast-paced workday.</p>,
  },
  {
    ...
    likes: 430,
    views: 1290,
    content: <p>Dive deep into modern digital expressionism and blending AI with brushstrokes.</p>,
  },
  {
    ...
    likes: 2140,
    views: 8750,
    content: <p>Mastering modern frameworks while optimizing low-level hardware performance layouts.</p>,
  },
  {
    ...
    likes: 1850,
    views: 4320,
    content: <p>Photographic captures detailing the rugged trails and natural giants of California.</p>,
  },
  {
    ...
    likes: 620,
    views: 1980,
    content: <p>How unexpected design alignments in urban spaces subconsciously impact creative output.</p>,
  },
  {
    ...
    likes: 3110,
    views: 9450,
    content: <p>Modding obsolete 8-bit sound chipboards into modern synth MIDI controllers.</p>,
  },
];
            ...
            <div className="flex flex-col gap-6 pb-6">
              ...
              <div className="grid grid-cols-1 gap-6 px-4 lg:px-6">
                <div className="flex flex-col xl:flex-row justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold">Popular by Category</h2>
                  </div>

                  <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full xl:w-1/2">
                    <TabsList variant={'line'} className="w-full justify-start overflow-x-auto">
                      ...
                      <TabsTrigger value="muzebox">MuzeBox</TabsTrigger>
                      <TabsTrigger value="posts">Posts</TabsTrigger>
                    </TabsList>
                    
                    <TabsContent value={activeTab} className="mt-4">
                      {/* <ChartBarMixed chartData={chartData} /> */}
                    </TabsContent>
                  </Tabs>
                </div>
              </div>
              ...
              <div className="px-4 lg:px-6">
                <div className="rounded-2xl border border-border bg-card p-4 shadow-sm">
                  <div className="text-sm text-muted-foreground">Data table coming soon...</div>
                </div>
              </div>
