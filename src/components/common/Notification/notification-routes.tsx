export const notificationRoutes: Record<string, (data: any) => string> = {
  ...
  "USER COMMENT ON STORY": (d) =>
    ...
    "USER RATED STORY": (d) => `/entertainment/storytelling/details/${d.titleId}`,
  ...
  "USER RATED GALLERY": (d) => `/entertainment/gallery/details/${d.titleId}`,


  // MuzeBox
  "USER LIKED MUZEBOX": (d) => `/entertainment/muze-box/details/${d.titleId}`,
  "USER COMMENT ON MUZEBOX": (d) =>
    `/entertainment/muzebox/details/${d.titleId}`,
    "USER RATED MUZEBOX": (d) => `/entertainment/muze-box/details/${d.titleId}`,
